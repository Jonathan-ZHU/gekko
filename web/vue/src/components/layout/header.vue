  ...
  <div class="" id="top">
    <nav class="nav">
      ...
      <div class="nav__content">
        <ul class="nav__items">
          <li class="nav__item"><router-link to="/home"><span  class="nav__item-text"> 主页 </span></router-link> </li>
          <li class="nav__item"><router-link to="/live-gekkos"><span  class="nav__item-text"> 活动 </span></router-link> </li>
          <li class="nav__item"><router-link to="/backtest"><span  class="nav__item-text"> 回测 </span></router-link> </li>
          <li class="nav__item"><router-link to="/data"><span  class="nav__item-text"> 数据 </span></router-link> </li>
          <li class="nav__item"><router-link to="/config"><span  class="nav__item-text"> 注册 </span></router-link> </li>
          <li class="nav__item"><a target="_blank" href="https://gekko.wizb.it/docs/introduction/about_gekko.html"><span  class="nav__item-text"> 文档 </span></a> </li>
        </ul>
      </div>
